...
variable "params" {
  default = [
    { name = "roboshop.dev.frontend.catalogue_url", value = "http://catalogue-dev.gmracademy.in.net/", type = "String" },
    { name = "roboshop.dev.frontend.user_url", value = "http://user-dev.gmracademy.in.net/", type = "String" },
    { name = "roboshop.dev.frontend.cart_url", value = "http://cart-dev.gmracademy.in.net/", type = "String" },
    { name = "roboshop.dev.frontend.payment_url", value = "http://payment-dev.gmracademy.in.net/", type = "String" },
    { name = "roboshop.dev.frontend.shipping_url", value = "http://shipping-dev.gmracademy.in.net/", type = "String" },
    ...
    { name = "roboshop.dev.shipping.cart_endpoint", value = "cart-dev.gmracademy.in.net:80", type = "String" },
